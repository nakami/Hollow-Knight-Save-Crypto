...
def main():
    ...
    decrypt_sp.add_argument('-i', '--input', type=str, help="hollow knight save file (.dat) to decrypt", required=True)
    ...
    encrypt_sp.add_argument('-i', '--input', type=str, help="hollow knight save file in json-format (.json)", required=True)
    encrypt_sp.add_argument('-o', '--output', type=str, help="file to output hollow knight save data", required=True)
