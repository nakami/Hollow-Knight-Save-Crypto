...
def main():
    ...
    decrypt_required_named.add_argument('-o', '--output', type=str, help="file to output the content of the hollow knight save file")
    ...
    encrypt_required_named.add_argument('-o', '--output', type=str, help="file to output hollow knight save data", required=True)
